...
.. NOTE:: turtlebot3_simulation package requires **`Turtlebot3 <http://turtlebot3.robotis.com/en/latest/pc_software.html#install-dependent-packages>`_** package as a prerequisite.
